    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col bg-zinc-950 px-5 py-6 text-zinc-50">
      <header className="space-y-3">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-300">
            Completa los ejercicios que conozcas. Cada fila guardada requiere kg, reps, series, RIR y dolor.
          </p>
        </div>
      </header>
      ...
      {baselineLifts.length > 0 ? (
        <section className="mt-6 rounded-3xl bg-zinc-900 p-4 ring-1 ring-emerald-400/30">
          ...
          <p className="mt-1 text-sm text-zinc-300">{baselineLifts.length} entradas listas para semana 1.</p>
        </section>
      ) : null}
