      ...
      <section className="flex flex-1 flex-col justify-center gap-8 py-10">
        {isReturningUser ? (
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-balance">Bienvenido de vuelta.</h1>
          </div>
        ) : (
          <>
            <div className="space-y-4">
              ...
              isReturningUser ? (
                <section aria-labelledby="m1-readiness-title" className="grid gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-zinc-300">{readiness.primaryAction.helperEs}</p>
                  </div>
                  <Link
                  ...
                  >
                    {readiness.primaryAction.labelEs}
                  </Link>
                </section>
              ) : (
                <section aria-labelledby="m1-readiness-title" className="grid gap-4">
